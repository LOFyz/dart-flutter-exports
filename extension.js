...
const extensionLink =
  'https://marketplace.visualstudio.com/items?itemName=elmsec.dart-flutter-exports';
...
function activate(context) {
  let disposable = vscode.commands.registerCommand(
    'dart-flutter-exports.createExporterFiles',
    (uri) => {
...
function generateFileContent(folderName, subfolders, files) {
  ...
  return `// generated by: ${extensionLink}:\n\n${exports}`;
}
